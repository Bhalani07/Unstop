...
namespace UnstopAPI.Migrations
{
    ...
    [Migration("20240729093643_ForeignkeyToElement")]
    partial class ForeignkeyToElement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UnstopAPI.Models.Element", b =>
                {
            ...
            modelBuilder.Entity("UnstopAPI.Models.FavoriteJob", b =>
                {
            ...
            modelBuilder.Entity("UnstopAPI.Models.Interview", b =>
                {
            ...
            modelBuilder.Entity("UnstopAPI.Models.JobFair", b =>
                {
                    ...
                    b.Property<List<string>>("JobLevel")
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("UnstopAPI.Models.OTP", b =>
                {
            ...
            modelBuilder.Entity("UnstopAPI.Models.Template", b =>
                {
                    b.Property<int>("TemplateId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("CorrectionLevel")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("UnstopAPI.Models.UserPreference", b =>
                {
            ...
            modelBuilder.Entity("UnstopAPI.Models.Application", b =>
                {
                    b.HasOne("UnstopAPI.Models.Candidate", "Candidate")
                        .WithMany()
            ...
            modelBuilder.Entity("UnstopAPI.Models.Element", b =>
                {
                    b.HasOne("UnstopAPI.Models.Template", "Template")
                        .WithMany()
            ...
            modelBuilder.Entity("UnstopAPI.Models.Interview", b =>
                {
                    b.HasOne("UnstopAPI.Models.Application", "Application")
                        .WithMany()
            ...
            modelBuilder.Entity("UnstopAPI.Models.JobFair", b =>
                {
                    b.HasOne("UnstopAPI.Models.Company", "Company")
                        .WithMany()
